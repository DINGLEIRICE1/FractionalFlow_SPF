...
saveas(figure(4),'Water Fractional Flow, Water and polymer Flooding,IC.tif')
...
saveas(figure(5),'Water Fractional Flow and shock, Water and Polymer Flooding,IC.tif')
...
saveas(figure(6),'Polymer shock, Polymer Flooding,IC.tif')
...
text(Scw-0.10,0.05,'Sw_i_w','color','k','fontsize',12)

hold off

saveas(figure(7),'Polymer shock, Water flooded residual oil,IC.tif')
...
V_PFt=V_PFf.*ones(1,(abs(i_OBt-i_OBf)+1));
Sw_PFt=Sw(i_OBt:i_OBf);
...
text(0.5,0.5,'Oil Bank','color','b','fontsize',14)
...
text(X_PFt(1),0.10,'Sw_i_w','color','k','fontsize',12)
...
saveas(figure(8),'Saturation profile, Polymer floodings, Water flooded residual oil,IC.tif')
...
saveas(figure(9),'Polymer shock, compare saturation,IC.tif')
...
ER_PF1=0;
ER_PF5=(1-fw_OBt)*(t_OBf2-t_OBf1);
ER_PF3=(1-fw_OBb)*(t_OBf3-t_OBf2)+ER_PF5;
...
hold on
plot(t_OBf2,ER_PF5,'co','MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',6)
plot(t_OBf3,ER_PF3,'co','MarkerEdgeColor','m','MarkerFaceColor','m','MarkerSize',6)
hold off

text(t_OBf2+0.1,ER_PF5,'t_s_h_o_c_k_1','color','g','fontsize',12)
text(t_OBf3+0.1,ER_PF3-0.02,'t_s_h_o_c_k_2','color','m','fontsize',12)
...
save PFEOR_His_IC.mat EOR1

saveas(figure(10),'Polymer EOR,IC.tif')
