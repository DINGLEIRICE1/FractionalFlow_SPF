...
Retar_Norm=0.0; % Normalized retadation factor
...
legend({'Surfactant Flooding, With Ads','Surfactant Flooding, No Ads'},'location','NorthWest','fontsize',11)
saveas(figure(11),'Comparison Surfactant EOR, With and Withourt Ads.tif')
