...
saveas(figure(1),'Relative Permeability, Water Flooding and Surfactant-Polymer Flooding, Extreme.tif')
...
saveas(figure(2),'Water Fractional Flow, Water Flooding, Extreme.tif')
...
saveas(figure(3),'Normalizd Water Fractional Flow, Water Flooding, Extreme.tif')
...
saveas(figure(4),'Water Fractional Flow, Water and Surfactant-Polymer Flooding, Extreme.tif')
...
saveas(figure(5),'Water Fractional Flow and shock, Water and surfactant-Polymer Flooding, Extreme.tif')
...
saveas(figure(6),'Surfactant shock, surfactant-Polymer Flooding, Extreme.tif')
...
saveas(figure(7),'Surfactant-Polymer shock, Water flooded residual oil, Extreme.tif')
...
saveas(figure(8),'Saturation profile, Surfactant-Polymer floodings, Water flooded residual oil, Extreme.tif')
...
saveas(figure(9),'Surfactant-Polymer shock, water shock comparison, Extreme.tif')
...
save SPFEOR_His_Ext.mat EOR1

saveas(figure(10),'Surfactant Polymer EOR Ext.tif')