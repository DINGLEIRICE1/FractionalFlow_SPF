...
up=10; % polymer viscosity 10 cP
uo=72; % oil viscosity, 5 cP
...
Siw_SF=eps; % connate water saturation
Sor_SF=eps; % residual oil saturation
Krw0_SF=1.0; % end point water relative permeability
Kro0_SF=1.0; % end point oil relative permeability
nw_SF=1; % corey component for water
no_SF=1; % corey component for oil
...
saveas(figure(1),'Relative Permeability, Water Flooding and Surfactant-Polymer Flooding, Miscible.tif')
...
saveas(figure(2),'Water Fractional Flow, Water Flooding, Miscible.tif')
...
saveas(figure(3),'Normalizd Water Fractional Flow, Water Flooding, Miscible.tif')
...
saveas(figure(4),'Water Fractional Flow, Water and Surfactant-Polymer Flooding, Miscible.tif')
...
saveas(figure(5),'Water Fractional Flow and shock, Water and surfactant-Polymer Flooding, Miscible.tif')
...
saveas(figure(6),'Surfactant shock, surfactant-Polymer Flooding, Miscible.tif')

%% Find the intersection, i.e., the oil bank water saturation

Sw_OB=fzero('find_S_OB_Ext',0.5); % find the oil bank water saturation
...
saveas(figure(7),'Surfactant-Polymer shock, Water flooded residual oil, Miscible.tif')
...
figure(8)
plot(X_SFb1,Sw_SFb1,'b',X_SFb2,Sw_SFb2,'b',X_SFt,Sw_SFt,'b','linewidth',2)
axis([0 1 0 1])
...
saveas(figure(8),'Saturation profile, Surfactant-Polymer floodings, Water flooded residual oil, Miscible.tif')
...
text(Sw_shock-0.11,fw_shock,'Sw_w_f','color','c','fontsize',12)
text(Sw_shock_SF-0.02,fw_shock_SF-0.05,'Sw_s_p','color','m','fontsize',12)

saveas(figure(9),'Surfactant-Polymer shock, water shock comparison, Miscible.tif')
...
save SPFEOR_His_Mis.mat EOR1

saveas(figure(10),'Surfactant Polymer EOR, Miscible.tif')