...
figure(1) % Polymer Flooding Fractional Flow Curve and Tangent Line, Water Sturation
...
figure(2) % Polymer & Water Flooing Fractional Flow Curve and Tangent Line, Water Sturation, Test
plot(Sw,fw,'b',Sw,fw_p,'r','linewidth',2)
axis([0 1 0 1])
xlabel('Sw, Water Saturation','fontsize',16)
ylabel('Water Fractional Flow','fontsize',16)
...
figure(3) % Polymer & Water Flooding Fractional Flow Curve and Tangent Line, Water Sturation
plot(Sw,fw,'b',Sw,fw_p,'r','linewidth',2)
axis([0 1 0 1])
xlabel('Sw, Water Saturation','fontsize',16)
ylabel('Water Fractional Flow','fontsize',16)
...
% Test location
figure(4) % Polymer & Water Flooding Fractional Flow Curve and Tangent Line, Water Sturation
plot(Sw,fw,'b',Sw,fw_p,'r','linewidth',2)
axis([0 1 0 1])
xlabel('Sw, Water Saturation','fontsize',16)
ylabel('Water Fractional Flow','fontsize',16)
...
figure(8) % Polymer & Water Flooding Fractional Flow Curve and Tangent Line, Water Sturation
load PFEOR_His_10cP.mat
t_OBf_All_10cP=EOR1(:,1);
EOR_All_10cP=EOR1(:,2);
plot(t_OBf_All_10cP,EOR_All_10cP,'b','linewidth',2)

hold on

load PFEOR_His_30cP.mat
t_OBf_All_30cP=EOR1(:,1);
EOR_All_30cP=EOR1(:,2);
plot(t_OBf_All_30cP,EOR_All_30cP,'g','linewidth',2)

load PFEOR_His_70cP.mat
t_OBf_All_70cP=EOR1(:,1);
EOR_All_70cP=EOR1(:,2);
plot(t_OBf_All_70cP,EOR_All_70cP,'r','linewidth',2)

load PFEOR_His_100cP.mat
t_OBf_All_100cP=EOR1(:,1);
EOR_All_100cPAds2=EOR1(:,2);
plot(t_OBf_All_100cP,EOR_All_100cPAds2,'k','linewidth',2)
...
legend({'PolVis=10 cP','PolVis=30 cP','PolVis=70 cP','PolVis=100 cP'},'location','NorthEast','fontsize',11)
saveas(figure(8),'Comparison Polymer EOR,Viscosity.tif')

figure(9) % Polymer & Water Flooding Fractional Flow Curve and Tangent Line, Water Sturation
load PF_Prof_10cP.mat
X_All=Pro1(:,1);
Sw_All=Pro1(:,2);
...
legend({'PolVis=10 cP','PolVis=30 cP','PolVis=70 cP','PolVis=100 cP'},'location','NorthEast','fontsize',11)
saveas(figure(9),'Comparison Saturation Profile of Polymer EOR,Viscosity.tif')
