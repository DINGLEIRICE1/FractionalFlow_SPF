...
global M no nw Siw Sor M_SP no_SF nw_SF Siw_SF Sor_SF deltafs_shock_SF Retar_Norm
...
Sw_shock_SF=fzero('find_shock_SP_Ads',0.9); % find the shock water saturation
...
saveas(figure(1),'Relative Permeability, Water Flooding and Surfactant-Polymer Flooding, With Ads.tif')
...
saveas(figure(4),'Water Fractional Flow, Water and Surfactant-Polymer Flooding, With Ads.tif')
...
saveas(figure(5),'Water Fractional Flow and shock, Water and surfactant-Polymer Flooding, With Ads.tif')
...
saveas(figure(6),'Surfactant shock, surfactant-Polymer Flooding, With Ads.tif')
...
legend({'Water Flooding','SP Flooding','Tangent Line,SPF','Shock,Water Front'},'Position',[0.365 0.75 0.1 0.15],'fontsize',10)
...
saveas(figure(7),'Surfactant-Polymer shock, Water flooded residual oil, With Ads.tif')
...
saveas(figure(8),'Saturation profile, Surfactant-Polymer floodings, Water flooded residual oil, With Ads.tif')
...
legend({'Water Flooding','SP Flooding','Tangent Line,WF','Tangent Line,SPF'},'Position',[0.36 0.75 0.1 0.15],'fontsize',10)
...
saveas(figure(9),'Surfactant-Polymer shock, water shock comparison, With Ads.tif')
...
save SPFEOR_His_Ads.mat EOR1

saveas(figure(10),'Surfactant Polymer EOR, With Ads.tif')

%% Compare the effect of adsorption
figure(11) % Polymer & Water Flooding Fractional Flow Curve and Tangent Line, Water Sturation
load SPFEOR_His_Ads.mat
t_OBf_All_Ads=EOR1(:,1);
EOR_All_Ads=EOR1(:,2);
plot(t_OBf_All_Ads,EOR_All_Ads,'b','linewidth',2)
hold on
load SPFEOR_His.mat
...
legend({'Surfactant Polymer Flooding, With Ads','Surfactant Polymer Flooding, No Ads'},'location','SouthEast','fontsize',11)
saveas(figure(11),'Comparison Surfactant Polymer EOR, With and Withourt Ads.tif')
