...
global M no nw Siw Sor M_SF no_SF nw_SF Siw_SF Sor_SF deltafs_shock_SF
...
%% Initial Condition
Sio=1-Siw; % Initial oil saturation
...
text(Scw-0.08,0.05,'Sw_i_w','color','k','fontsize',12)

hold off

saveas(figure(7),'Surfactant shock, Connate oil.tif')
...
V_SFt=V_SFf*ones(1,(abs(i_OBt-i_OBf)+1));
Sw_SFt=Sw(i_OBt:i_OBf);
...
text(0.6,0.25,'Oil Bank','color','b','fontsize',12)
...
text(X_SFt(1)-0.05,0.1,'Sw_i_w','color','k','fontsize',12)
...
save SF_Prof_IC.mat Pro1

saveas(figure(8),'Saturation profile, Surfactant floodings, Connate oil.tif')
...
saveas(figure(9),'Surfactant shock, water shock comparison.tif')
...
ER_SF1=0;
ER_SF5=(1-fw_OBt)*(t_OBf2-t_OBf1);
ER_SF3=(1-fw_OBb)*(t_OBf3-t_OBf2)+ER_SF5;
...
hold on
plot(t_OBf2,ER_SF5,'co','MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',6)
plot(t_OBf3,ER_SF3,'co','MarkerEdgeColor','m','MarkerFaceColor','m','MarkerSize',6)
hold off

text(t_OBf2+0.1,ER_SF5,'t_s_h_o_c_k_1','color','g','fontsize',12)
text(t_OBf3+0.1,ER_SF3-0.02,'t_s_h_o_c_k_2','color','m','fontsize',12)
...
saveas(figure(11),'Comparison Surfactant EOR, IC.tif')

%% Comparison Saturation Profile of Surfactant EOR
...
saveas(figure(12),'Comparison Saturation Profile of Surfactant EOR, IC.tif')
