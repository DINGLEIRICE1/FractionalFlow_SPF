...
global M no nw Siw Sor Sw_shock_p M_SF no_SF nw_SF Siw_SF Sor_SF deltafs_shock_SF
...
M_SF=Krw0_SF*uo/Kro0_SF/up; % Mobility ratio
...
M_SF=Krw0_SF*uo/Kro0_SF/up; % Surfactant Flooding Mobility ratio
fw_SF=Snw_SF;
fo_SF=fw_SF;
fw_SF=1./(1+Kro_SF.*up./(Krw_SF.*uo));
...
V_SF=dfds_SF; %
[deltaf_SF_OBb,i_OBb]=max(deltafs_SF); %
